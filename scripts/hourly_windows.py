...
# Windows python interpreter (current conda env)
TARGET_PYTHON = r"C:\miniconda3\envs\py311\python.exe"

# Internal log file path (relative to repository root)
LOG_FILE_RELATIVE = "logs/hourly_windows.log"

# Always run both jobs. Execution time is controlled by Task Scheduler.
